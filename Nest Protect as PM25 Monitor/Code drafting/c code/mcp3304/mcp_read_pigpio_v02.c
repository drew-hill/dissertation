/* 
    V0.2
   Jan 12, 2017 by L. Drew Hill at UC Berkeley
   Changes: increase delay between LED drive and ADC read (from ~ 24 µs to ~ 141 µs)
...
void *ir_loop (void* pString)
{
  ...
  char *FILENAME = "nest_c_pingratetest_jan11.txt";
